     ...
     <div class="col-9">
        ...
        @foreach ($recommend_products as $recommend_product)
             <div class="col-4">
                 ...
                 <div class="row">
                     <div class="col-12">
                     <div class="samuraimart-star-rating-wrap"><span class="samuraimart-star-rating" data-rate="{{round($recommend_product->averageScore()*2)/2}}"></span>{{$recommend_product->averageScore()}}</div>
        ...
        @endforeach
         ...
         @foreach ($recently_products as $recently_product)
                 <div class="col-3">
                     ...
                     <div class="row">
                         <div class="col-12">
                         <div class="samuraimart-star-rating-wrap"><span class="samuraimart-star-rating" data-rate="{{round($recently_product->averageScore()*2)/2}}"></span>{{$recently_product->averageScore()}}</div>
                             <p class="samuraimart-product-label mt-2">
